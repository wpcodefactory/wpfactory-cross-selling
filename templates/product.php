...
<div class="wpfcs-product <?php echo esc_attr( $pro_version_installed_class ) ?>">
	<?php if ( isset( $product_data['icon_url'] ) ): ?>
		<div class="wpfcs-product-img-wrapper">
			<img src="<?php echo esc_attr( $product_data['icon_url'] ) ?>"/>
		</div>
	<?php endif; ?>
	<div class="wpfcs-product-middle">
		<h3 class="wpfcs-product-title"><?php echo esc_html( $product_data['name'] ) ?></h3>
